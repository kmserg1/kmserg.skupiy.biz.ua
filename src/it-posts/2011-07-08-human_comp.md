...
Елементарний двійковий суматор має два входи і один вихід. Він може складати тільки однорозрядні двійкові числа таким чином:
...
Двійковий суматор для кожного розряду у багаторозрядному суматорі має три входи і два виходи:

Входи: 
Два входи - це відповідні роздяди двох чисел, які ми складаємо.
Третій вхід - лінія переносу розряду від попереднього розряду суматора.

Виходи:
Перший - результат складання (0 чи 1).
Другий - лінія переноса розряду до наступного розряду суматора.

Повний суматор складається з двійкових суматорів для кожного розряду, які розташовані один за одним і з'єднані через лінії переносу розряду. 

Наприклад схема чотирирозрядного суматора:

![схема 4-розоядного суматора](/images/four-bit-adder.png)



Щоб двійковий суматор для конкретного розряду виконав свою роботу, він повинен отримати коректні дані на всі свої входи.

Перед початком роботи ми маємо значення для двох входів - це відповідні роздяди двох початкових чисел.
Щоб отримати значення на третьому вході, повинна бути виконана робота попередніми двійковими суматорами. Тльки тоді ми дізнаємося,
яке значення має вхід переносу розряду.

Приймемо, що для виконання обчислення суматору кожного розряду потрібен один такт часу.
Тоді, суматор n-го розряда отримає коректне значення на вході переносу розряду на n-му такті роботи.
Таким чином, щоб скласти два n-розрядних двійкових числа нам потрібно n тактів часу.

**Робимо 10-розрядний суматор із людей.**

Він зможе складати, кожне з яких буде мати значення від 0 до 1024.
Результат складання також буде в межах від 0 до 1024. Крім того ми матимемо значення виходу переносу 10-го розряду, по значенню якого 
будемо знати, чи не перевищив наш результат максимальне значення 1024.
...
Прапорцямі в суматорі будуть наші виходи. Білим прапорецем показується результат складання у розряді, а чорним - пернос значення у наступний розряд.
...
Одна людина в нашому суматорі буде виконувати роль двійкового суматору розряду.
...
Резульат - це значення (піднятий чи опущений) білих прапорців.


Алгорим роботи людини у суматорі. 
Початковий стан прапорців - опущені.
1. Чекати. Коли почуєш сигнал від диригента, то:
	1.а) спочатку обробляєш значення сусідів зліва і справа (відповідних розрядів вхідних регістрів) 
	   Тому дивишся по черзі наліво і направо. 
	    1.а).1 - Якщо і там і там нема піднятих прапорців, то не білий прапорець - донизу.
	    1.а).2 - Якщо один з прапорців піднятий, а інший опущений, то білий прапорець - уверх.
	    1.а).3 - Якщо оба прапорця підняті, то білий прапорець -  донизу і чорний прапорець - уверх.
	б) потім обробляєш значення входа переноса розряду.
	   Тому дивишся на людину спереду себе.
	   1.б).1 - Якщо там чорний прапорець унизу, то нічого не робиш
	   1.б).2 - Якщо там чорний піднято, то :
		1.б).2.а) - Якщо у нас піднято білий прапорець, то білий - донизу, а чорний - уверх.
		1.б).2.а) - Якщо у нас опущений білий прапорець, то білий - уверх, а чорний - без змін.
2. Перехід до п.1

Результат показано на малюнку
![10-розрядний суматор з людей](/images/ranks.png) 